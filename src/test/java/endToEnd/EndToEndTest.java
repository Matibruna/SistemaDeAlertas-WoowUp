...
public class EndToEndTest {
    ...
    public void update_alerts(){
        ...
        // Alerta para topic - Tecnologías de desarrollo
        ...
        // Alerta para topic1 - Metodologías de desarrollo
        ...
        // Se verificarán los cuerpos de las alertas ya que desde esta implementación, no tenemos todos los datos del objeto Alerta generado.
        assertEquals(
                List.of(
                        alertBody,
                        alertBody1
        ...
        // Y se verifica lo mismo para el user1, que en este caso, solo estaba suscrito a topi1 - Metodologías de desarrollo.
        assertEquals(
                List.of(
                        alertBody1
                ),
        ...
        // Validamos tambien si un usuario marca una alerta como leída, no volverá a aparecer cuando obtengamos las notificaciones.

        // Marcamos la segunda Alerta de user como leida (Podria haber sido la primera o ambas)
        user.getNotifications().get(1).markAsRead();

        // Y verificamos para ambos usuarios que ahora solo tendran como notificación la alerta de topic1 - Metodologias de desarrollo
        assertEquals(
                List.of(
                        alertBody
                ),
